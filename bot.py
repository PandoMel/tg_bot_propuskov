...
#work token and group
# bot = Bot(token="7941425527:AAG80CxDb2FiYVvqMa8B9Ll3NfdrD8Ih0YI") # Объект бота с указанием токена
# OHRANA_ID = -1002327700248 # Канал куда отправлять заявку пользователя
# CHANNEL_ID = -1002410108204 # Группа-база данных, откуда бот будет проверять наличие доступа к своим функциям -4507599030
